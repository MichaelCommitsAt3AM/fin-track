...
import com.fintrack.app.core.domain.model.onboarding.MerchantFrequency
import com.fintrack.app.core.domain.model.onboarding.OnboardingInsights
import com.fintrack.app.core.domain.model.onboarding.RecurringPaybill
...
class MpesaAnalyticsEngine @Inject constructor(
    ...
    suspend fun generateInsights(): OnboardingInsights = withContext(Dispatchers.IO) {
        ...
        val frequentMerchants = frequentMerchantsRaw.map { result ->
            ...
            val recentTransactions = com.fintrack.app.core.data.mapper.MpesaTransactionMapper.toDomainList(recentEntities)
