...
// Mappers
fun Debt.toUiModel(payments: List<com.example.fintrack.core.domain.model.Payment> = emptyList()): DebtGoal {
    return DebtGoal(
        id = this.id,
        title = this.title,
...
fun com.example.fintrack.core.domain.model.Payment.toUiModel(): UiPayment {
    return UiPayment(
        id = this.id,
        amount = this.amount,
        date = this.date,
...
fun Saving.toUiModel(contributions: List<com.example.fintrack.core.domain.model.Contribution> = emptyList()): SavingGoal {
    return SavingGoal(
        id = this.id,
        title = this.title,
...
fun com.example.fintrack.core.domain.model.Contribution.toUiModel(): UiContribution {
