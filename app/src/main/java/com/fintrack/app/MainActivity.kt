...
import com.fintrack.app.core.ui.components.BottomNavBar
import com.fintrack.app.presentation.MainViewModel
...
import com.fintrack.app.presentation.common.components.OfflineBanner
import com.fintrack.app.presentation.navigation.AppRoutes
import com.fintrack.app.presentation.navigation.NavGraph
import com.fintrack.app.presentation.ui.theme.FinTrackTheme
...
class MainActivity : FragmentActivity() { // Changed to FragmentActivity for BiometricPrompt
    ...
    @Inject lateinit var settingsIntegration: com.fintrack.app.presentation.navigation.SettingsIntegration
    @Inject lateinit var onboardingIntegration: com.fintrack.app.presentation.navigation.OnboardingIntegration
                ...
                if (isAppLocked) {
                    ...
                    LaunchedEffect(isOnline) {
                        if (isOnline && currentRoute in mainTabRoutes) {
                            ...
                            val syncWork = androidx.work.OneTimeWorkRequestBuilder<com.fintrack.app.core.worker.TransactionSyncWorker>()
                                .setConstraints(com.fintrack.app.core.worker.TransactionSyncWorker.getConstraints())
                                .build()
                            
                            workManager.enqueueUniqueWork(
                                com.fintrack.app.core.worker.TransactionSyncWorker.WORK_NAME,
                    ...
                    Box(modifier = Modifier.fillMaxSize()) {
                        ...
                        ModalNavigationDrawer(
                            ...
                            drawerContent = {
                                com.fintrack.app.presentation.home.ProfileDrawerContent(
                                    user = currentUser,
                                    onCloseDrawer = {
